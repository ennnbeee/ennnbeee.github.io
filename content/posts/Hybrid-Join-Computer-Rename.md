...
hero: /img/computer-name.png # image path/url
...
```
## The Whole Thing
The full script can be found [here](https://github.com/ennnbeee/mem-scripts/blob/main/MEM/OS_Windows/Invoke-ComputerRename/Invoke-ComputerRename-HDJ.ps1), I would **strongly** advise testing this prior to pushing it out via Endpoint Manager.
